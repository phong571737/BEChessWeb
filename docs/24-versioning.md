...
The current application release is the value in the root package, frontend package, and `frontend/lib/app-version.ts`. At this documentation audit the source commit is `069334c`; update this text when a release tag is created.
