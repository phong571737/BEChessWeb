...
- confirm global `esp_move` is emitted after a legal move and that each client filters the expected `gameID`
...
- [27-debugging-guide.md](27-debugging-guide.md) provides the command reference and the step-by-step root-cause workflow used during development and VPS diagnosis.
