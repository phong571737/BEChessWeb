...
The current application release is `v1.1.1-change15`. The root package, frontend package, and `frontend/lib/app-version.ts` must use the same version.
