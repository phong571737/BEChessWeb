export const en = {
    ...
    "rev.editUciHistory": "Edit e-board moves",
    "rev.saveUciHistory": "Save e-board moves",
    "rev.savingUciHistory": "Saving moves...",
    "rev.uciSaveFailed": "Unable to save e-board moves.",
    "rev.uciEditorPlaceholder": "One UCI move per line, for example e2e4",
