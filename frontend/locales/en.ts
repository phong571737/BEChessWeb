export const en = {
    "recoveryTree.title": "Choose recovered moves",
    "recoveryTree.group": "Recovery group (fewest padding moves first)",
    "recoveryTree.groupOption": "Group {number} · {count} padding moves · {paths} paths",
    "recoveryTree.point": "Recovery point",
    "recoveryTree.pointOption": "Point {number} · ply {ply}",
    "recoveryTree.previous": "Previous point",
    "recoveryTree.next": "Next point",
    "recoveryTree.choices": "Compatible recovered moves",
    "recoveryTree.continuations": "{count} continuations",
    "recoveryTree.suggested": "Suggested",
    "recoveryTree.score": "{value} pawns",
    "recoveryTree.perspective": "Stockfish score after each move, from the moving side's perspective.",
    "recoveryTree.white": "White",
    "recoveryTree.black": "Black",
    "recoveryTree.unscored": "Not evaluated",
    "recoveryTree.encodedScore": "Encoded score: {value}",
    "recoveryTree.noPadding": "No padding moves to evaluate.",
    "recoveryTree.partial": "Recovered through observation {count}. The remaining observations are unresolved; the original FEN history is preserved.",
    ...
    "home.boardReady": "Ready",
    "home.boardPressButton": "Press clock",
    "home.boardCheck": "Check pieces",
    "home.boardWaiting": "Waiting",
    "home.boardChecking": "Checking",
    "home.invalidFen": "Invalid FEN",
    "bulk.open": "Tournament setup",
    "bulk.title": "Tournament setup",
    "bulk.hint": "Import one pairing workbook and apply it to multiple live boards.",
    "bulk.importHint": "Rows are matched to boards by board number or board ID.",
    "bulk.matchedBoards": "{count} matched boards",
    "bulk.selectedBoards": "{count} selected boards",
    "bulk.mappingHint": "Choose the workbook board and pairing for each physical board.",
    "bulk.selectMatches": "Select matches",
    "bulk.matchOption": "Match {number}",
    "bulk.noActiveMatches": "No active matches.",
    "bulk.tournamentLabel": "Tournament name",
    "bulk.tournamentPlaceholder": "Enter tournament name",
    "bulk.fileBoard": "File board {board}",
    "bulk.targetBoard": "Choose the physical board for file board {board}",
    "bulk.sourceBoard": "Choose the workbook board for physical board {board}",
    "bulk.noBoard": "Do not apply",
    "bulk.noPairing": "No pairing selected",
    "bulk.selectAll": "Select all",
    "bulk.selectBoard": "Select {board}",
    "bulk.noMatchedBoards": "No active board matches the imported pairing rows.",
    "bulk.noBoardsSelected": "Select at least one matched board.",
    "bulk.applyClock": "Apply this time control to selected boards",
    "bulk.save": "Save {count} boards",
    "bulk.saveError": "Unable to save the selected board setup.",
    "bulk.partialFailure": "{count} boards could not be updated. Reload and try those boards again.",
    "bulk.spectatorDelay": "Spectator delay",
    "bulk.spectatorDelayUnit": "seconds",
    "bulk.spectatorDelayPresets": "Quick presets",
    "bulk.delayPresetSeconds": "{count} sec",
    "bulk.delayPresetMinutes": "{count} min",
    "bulk.saveDelay": "Save delay",
    "bulk.delayLoadError": "Unable to load the spectator delay.",
    "bulk.delaySaveError": "Unable to save the spectator delay.",
    ...
    "sg.boardNumberSelect": "Select a chessboard",
    "sg.boardNumberOther": "Other",
    "sg.boardNumberOtherPlaceholder": "Enter a chessboard number greater than 10",
    "sg.boardNumberInvalid": "Please select a chessboard.",
    "sg.boardNumberCustomInvalid": "The custom chessboard number must be greater than 10.",
    "sg.time": "Time",
    ...
    "board.initWaiting": "Waiting for the physical board to send its initialization check...",
    "board.initChecking": "Checking piece positions...",
    "board.invalidFenWarning": "Invalid FEN received",
    "board.fenUciMismatchWarning": "FEN does not match UCI",
    "board.uciXWarning": "UCI = X received",
    "board.dataWarningMultiple": "{first}; {second}",
    "board.dataWarningAtSeq": "{reason} · sequence {seq}",
    ...
    "rev.addFen": "Add FEN",
    "rev.addFenTitle": "Add FEN snapshot",
    "rev.addFenDescription": "The new position will be appended to the end of this history record.",
    "rev.editFen": "Edit FEN",
    "rev.editFenPosition": "Edit FEN {number}",
    "rev.editFenTitle": "Edit FEN snapshot",
    "rev.editFenDescription": "Replace FEN {number}. PGN and electronic-board moves will remain unchanged.",
    "rev.fenValue": "FEN position",
    "rev.fenPlaceholder": "Enter the FEN snapshot to store",
    "rev.invalidFen": "Enter a non-empty FEN value.",
    "rev.saveFen": "Save FEN",
    "rev.saveFenFailed": "Unable to save this FEN. Reload the game and try again.",
    "rev.deleteFen": "Delete FEN",
    "rev.deleteFenPosition": "Delete FEN {number}",
    "rev.deleteFenTitle": "Delete this FEN snapshot?",
    "rev.deleteFenDescription": "FEN {number} will be removed from this history record. The PGN and electronic-board moves will remain unchanged.",
    "rev.deleteFenFailed": "Unable to delete this FEN. Reload the game and try again.",
    "rev.replaceFenList": "Replace list",
    "rev.replaceFenListTitle": "Replace the FEN list",
    "rev.replaceFenListDescription": "Paste the complete replacement sequence, one FEN per line. Number prefixes are optional. Chess legality is not checked before saving. This clears saved analysis but leaves PGN and electronic-board moves unchanged.",
    "rev.fenListValue": "FEN sequence",
    "rev.fenListPlaceholder": "1. complete FEN\n2. complete FEN",
    "rev.bulkFenEmpty": "Enter at least one FEN position.",
    "rev.bulkFenInvalid": "FEN {number} is empty or is not text.",
    "rev.bulkFenFailed": "Unable to replace the FEN list. Reload the game and try again.",
    "rev.savingFenList": "Saving list...",
    ...
    "rev.editPgn": "Edit PGN",
    "rev.savePgn": "Save PGN",
    "rev.savingPgn": "Saving PGN...",
    "rev.pgnSaveFailed": "Unable to save PGN.",
    "rev.pgnEditorPlaceholder": "Paste the corrected PGN here",
    ...
    "played.editResultDescription": "Set the result for {players}. Saving replaces any existing result.",
    ...
    "dashboard.totalOnlineDuration": "Total online time",
    "dashboard.totalOfflineDuration": "Total offline time",
    ...
    "analysis.boardDisplayControls": "Board display controls",
