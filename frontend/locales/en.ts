export const en = {
    ...
    "rev.stockfishBreakdown": "Move classifications",
    ...
    "settings.moveSuggestions": "Move suggestions",
    "home.arrangeBoards": "Arrange boards",
    "home.moveBoardEarlier": "Move board earlier",
    "home.moveBoardLater": "Move board later",
    ...
    "guide.qrZoom": "Open QR code in a larger view",
    "guide.qrDownload": "Download QR code",
    "guide.qrClose": "Close QR code preview",
    ...
    "dashboard.onlineByDay": "Online time by day",
    "dashboard.onlineSessions": "Board online sessions",
    "dashboard.onlineSessionsDescription": "Each session runs from the online event to the offline event; offline time is not included.",
    "dashboard.noOnlineSessions": "No online sessions in this period.",
    "dashboard.onlineFrom": "Online from",
    "dashboard.onlineTo": "Until",
