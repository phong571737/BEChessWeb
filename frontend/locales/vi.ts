...
export const vi: Record<TranslationKeys, string> = {
    ...
    "board.showSuggestions": "Hiện gợi ý và thanh đánh giá",
    "board.hideSuggestions": "Ẩn gợi ý và thanh đánh giá",
    "board.showEvaluation": "Hiện thanh đánh giá",
    "board.hideEvaluation": "Ẩn thanh đánh giá",
    "board.showSuggestionsOnly": "Hiện gợi ý nước đi",
    "board.hideSuggestionsOnly": "Ẩn gợi ý nước đi",
    ...
    "rev.showSuggestions": "Hiện gợi ý và thanh đánh giá",
    "rev.hideSuggestions": "Ẩn gợi ý và thanh đánh giá",
    "rev.showSuggestionsOnly": "Hiện gợi ý nước đi",
    "rev.hideSuggestionsOnly": "Ẩn gợi ý nước đi",
