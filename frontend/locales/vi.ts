...
export const vi: Record<TranslationKeys, string> = {
    "recoveryTree.title": "Chọn nước phục hồi",
    "recoveryTree.group": "Nhóm phục hồi (ưu tiên ít nước padding)",
    "recoveryTree.groupOption": "Nhóm {number} · {count} nước padding · {paths} phương án",
    "recoveryTree.point": "Điểm phục hồi",
    "recoveryTree.pointOption": "Điểm {number} · nửa nước {ply}",
    "recoveryTree.previous": "Điểm trước",
    "recoveryTree.next": "Điểm tiếp",
    "recoveryTree.choices": "Các nước phục hồi tương thích",
    "recoveryTree.continuations": "{count} cách tiếp diễn",
    "recoveryTree.suggested": "Gợi ý",
    "recoveryTree.score": "{value} tốt",
    "recoveryTree.perspective": "Điểm Stockfish sau mỗi nước đi, theo góc nhìn bên thực hiện nước đó.",
    "recoveryTree.white": "Trắng",
    "recoveryTree.black": "Đen",
    "recoveryTree.unscored": "Chưa đánh giá",
    "recoveryTree.encodedScore": "Điểm quy đổi: {value}",
    "recoveryTree.noPadding": "Không có nước padding cần chấm điểm.",
    "recoveryTree.partial": "Phục hồi đến quan sát {count}. Các quan sát sau đó chưa phục hồi; lịch sử FEN gốc vẫn được giữ nguyên.",
