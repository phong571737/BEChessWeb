...
export const vi: Record<TranslationKeys, string> = {
    ...
    "home.invalidFen": "FEN không hợp lệ",
    "home.check": "Chiếu tướng",
    "home.checkmate": "Chiếu hết",
    "bulk.open": "Thiết lập giải đấu",
    "bulk.title": "Thiết lập giải đấu",
    "bulk.hint": "Nhập một file ghép cặp và áp dụng cho nhiều bàn cờ đang hoạt động.",
    "bulk.importHint": "Mỗi dòng được ghép với bàn theo số bàn hoặc ID bàn cờ.",
    "bulk.matchedBoards": "Đã khớp {count} bàn cờ",
    "bulk.selectedBoards": "Đã chọn {count} bàn cờ",
    "bulk.mappingHint": "Chọn bàn trong file và cặp đấu cho từng bàn cờ vật lý.",
    "bulk.selectMatches": "Chọn trận",
    "bulk.matchOption": "Trận {number}",
    "bulk.noActiveMatches": "Không có trận đang hoạt động.",
    "bulk.tournamentLabel": "Tên giải đấu",
    "bulk.tournamentPlaceholder": "Nhập tên giải đấu",
    "bulk.fileBoard": "Bàn trong file {board}",
    "bulk.targetBoard": "Chọn bàn cờ vật lý cho bàn {board} trong file",
    "bulk.sourceBoard": "Chọn bàn trong file cho bàn cờ vật lý {board}",
    "bulk.noBoard": "Không áp dụng",
    "bulk.noPairing": "Chưa chọn cặp đấu",
    "bulk.selectAll": "Chọn tất cả",
    "bulk.selectBoard": "Chọn {board}",
    "bulk.noMatchedBoards": "Không có bàn cờ đang hoạt động nào khớp với các dòng trong file.",
    "bulk.noBoardsSelected": "Hãy chọn ít nhất một bàn cờ đã khớp.",
    "bulk.applyClock": "Áp dụng thời gian này cho các bàn đã chọn",
    "bulk.save": "Lưu {count} bàn cờ",
    "bulk.saveError": "Không thể lưu cài đặt cho các bàn cờ đã chọn.",
    "bulk.partialFailure": "Không thể cập nhật {count} bàn cờ. Hãy tải lại và thử lại các bàn đó.",
    "bulk.spectatorDelay": "Độ trễ người xem",
    "bulk.spectatorDelayUnit": "giây",
    "bulk.spectatorDelayPresets": "Mốc nhanh",
    "bulk.delayPresetSeconds": "{count} giây",
    "bulk.delayPresetMinutes": "{count} phút",
    "bulk.saveDelay": "Lưu độ trễ",
    "bulk.delayLoadError": "Không thể tải độ trễ người xem.",
    "bulk.delaySaveError": "Không thể lưu độ trễ người xem.",
    ...
    "settings.moveSuggestions": "Đề xuất nước đi",
    "home.arrangeBoards": "Sắp xếp bàn",
    "home.moveBoardEarlier": "Chuyển bàn về trước",
    "home.moveBoardLater": "Chuyển bàn về sau",
    ...
    "dashboard.playing": "Đang chơi",
    "dashboard.completed": "Hoàn thành",
    "dashboard.totalOnlineDuration": "Tổng thời gian online",
    "dashboard.totalOfflineDuration": "Tổng thời gian offline",
    "dashboard.onlineByDay": "Thời gian online theo ngày",
    "dashboard.onlineSessions": "Các phiên online của bàn cờ",
    "dashboard.onlineSessionsDescription": "Mỗi phiên tính từ lúc nhận online đến lúc nhận offline; thời gian offline không được cộng.",
    "dashboard.noOnlineSessions": "Chưa có phiên online trong khoảng thời gian này.",
    "dashboard.onlineFrom": "Online từ",
    "dashboard.onlineTo": "Đến",
