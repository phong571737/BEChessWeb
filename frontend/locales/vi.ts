...
export const vi: Record<TranslationKeys, string> = {
    ...
    "rev.editUciHistory": "Chỉnh sửa nước đi từ bàn cờ",
    "rev.saveUciHistory": "Lưu nước đi từ bàn cờ",
    "rev.savingUciHistory": "Đang lưu nước đi...",
    "rev.uciSaveFailed": "Không thể lưu nước đi từ bàn cờ.",
    "rev.uciEditorPlaceholder": "Mỗi dòng một nước UCI, ví dụ e2e4",
